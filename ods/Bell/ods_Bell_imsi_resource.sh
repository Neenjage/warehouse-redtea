...
clickhouse-client -u$user --multiquery -q"drop table ods.ods_Bell_imsi_resource"

clickhouse-client -u$user --multiquery -q"rename table ods.ods_Bell_imsi_resource_tmp to ods.ods_Bell_imsi_resource"
