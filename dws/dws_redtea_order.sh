                ...
                (
                    ...
                    (
                        SELECT
                            ...
                            data_plan_detail.resource_value as resource_value,
                            ...
                            order_detail.netless_order_flag,
