...
drop table if exists ads.ads_order_sales_Einstein_aboard_report_tmp;

create table ads.ads_order_sales_Einstein_aboard_report_tmp
Engine=MergeTree
...
where source = 'Einstein' and (residence = 'CN' or residence = '')
...
drop table if exists ads.ads_order_sales_Einstein_aboard_report;

rename table ads.ads_order_sales_Einstein_aboard_report_tmp to ads.ads_order_sales_Einstein_aboard_report;
"