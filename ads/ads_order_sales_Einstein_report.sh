...
drop table if exists ads.ads_order_sales_Einstein_report_tmp;

create table ads.ads_order_sales_Einstein_report_tmp
Engine=MergeTree
...
drop table if exists ads.ads_order_sales_Einstein_report;

rename table ads.ads_order_sales_Einstein_report_tmp to ads.ads_order_sales_Einstein_report;
"